                ...
                <div key={member.id} className="team-member">
                  ...
                  <div>
                    {member.linkedin && (
                      ...
                      >
                        <img className="contact-icon" src="../public/Team/linkedin.png" alt={member.name + "'s LinkedIn"} />
                      </a>
                    )}
                    {member.github && (
                      <a 
                      ...
                      >
                        <img className="contact-icon" src="../public/Team/github.png" alt={member.name + "'s GitHub"} />
                      </a>
                    )}
                  </div>
                </div>
